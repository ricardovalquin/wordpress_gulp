This is a boilerplate project to create a wordpress project integrated with gulp to use livereload, preprocess sass files, minify css and js files and transpire ES6 into ES5.
